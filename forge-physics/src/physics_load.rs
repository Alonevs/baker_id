...
pub struct PhysicsWorldLoadData {
    pub bodies: Vec<PhysicsBodyLoadData>,
    pub constraints: Vec<ConstraintLoadData>,
    pub gravity: [f32; 2],
    pub dt: f32,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PhysicsBodyLoadData {
    pub id: String,
    pub name: String,
